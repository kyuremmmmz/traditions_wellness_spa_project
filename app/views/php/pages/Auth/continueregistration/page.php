...
class Page{
    public static function page(){
        ...
        echo                '<div class="w-[284px] px-[14px] relative -top-[10px]">';
                                Text::render('','', 'CaptionOne text-onBackgroundTwo dark:text-darkOnBackgroundTwo w-[284px] mb-[3px] mt-[12px]','Your username must contain at least:');
        echo                    '<div class="flex items-center gap-[7px]">';
                                    IconChoice::render('miniCircle','[8px]','[8px]',$usernameCharactersCircle,);
                                    Text::render('','', 'CaptionOne text-onBackgroundTwo dark:text-darkOnBackgroundTwo w-[284px] mb-[2px]','Between 8 and 20 characters long.');
        ...
        echo                    '<div class="flex items-center gap-[7px]">';
                                    ...
                                    Text::render('','', 'CaptionOne text-onBackgroundTwo dark:text-darkOnBackgroundTwo w-[284px] mb-[2px]','Only letters, numbers, and underscores.');
        ...
        echo                    '<div class="flex items-center gap-[7px]">';
                                    ...
                                    Text::render('','', 'CaptionOne text-onBackgroundTwo dark:text-darkOnBackgroundTwo w-[284px] mb-[2px]','No other special characters.');
