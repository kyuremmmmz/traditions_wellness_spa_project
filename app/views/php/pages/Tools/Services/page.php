        ...
        <main class="flex w-full">
            ...
            <div id="main" class="sm:ml-[48px] overflow-y-auto sm:px-[0px] px-[48px] flex flex-col mt-[104px] sm:mt-[0px] sm:items-center sm:justify-center sm:h-screen  w-full">
                <div>
                    ...
                    <section class="flex gap-[16px] py-[16px]"> <?php ActionButtons::render([['id' => 'openAddANewServiceSectionButton', 'content' => '+ Add a new service'],['id' => 'openAddANewAddOnSectionButton', 'content' => '+ Add a new add-on']]); ?> </section>
                    <section> <?php LazyRowButtons::render([['showAllServices', 'All Services'], ['showMassages', 'Massages'], ['showBodyScrubs', 'Body Scrubs'], ['showPackages', 'Packages'], ['showAddOns', 'Add-ons'], ['showArchivedServices', 'Archived Services'], ['showArchivedAddOns', 'Archived Add-on']]); ?> </section>
