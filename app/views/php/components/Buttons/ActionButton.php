...
class ActionButton
{
    public static function render(string $iconChoice, string $content, string $id): void
    {
        ...
        echo '<button class="text-onPrimary dark:text-darkOnPrimary transition-all ease-in-out BodyTwo bg-primary dark:bg-darkPrimary hover:bg-primaryHover dark:hover:bg-darkPrimaryHover disabled:bg-secondaryVariant rounded-[6px] w-[219px] h-[40px]" id="' . $id . '">
