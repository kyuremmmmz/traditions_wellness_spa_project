...
namespace Project\App\Views\Php\Components\DatePicker;

use Project\App\Views\Php\Components\Icons\IconChoice;

class DatePicker
{
    public static function render(string $label, ?string $name = null, ?string $id = null, ?string $defaultValue = null): void
    {
