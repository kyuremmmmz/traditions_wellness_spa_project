...
class NewService
{
    public static function render(): void
    {
        ...
        <form action="/createService" id="addServiceForm" method="post" enctype="multipart/form-data">
            <div id="AddANewServiceSection" class="pl-[0px] sm:pl-[48px] w-full overflow-x-auto max-w-full pt-[48px] pl-[48px] sm:pl-0 overflow-y-auto fixed inset-0 bg-background dark:bg-darkBackground flex flex-col transform translate-x-full transition-transform duration-300 ease-in-out z-[50]">
                <?php BackButton::render('closeAddANewServiceButton'); ?>
                <div class="sm:w-[3200px] flex flex-col sm:p-[48px] ">
                    <div class="w-full flex flex-col sm:flex-row gap-[100px] mt-[0px] sm:mt-[48px] 2xl:pb-0">
                        <section class="flex flex-col gap-[16px] w-[400px] sm:w-[400px]">
                            ...
                            <div class="flex flex-col mt-[54px] gap-[16px]">
                                ...
                                <?php SecondaryInputField::render('textareafield', 'Description', 'Enter Description', [], 'service_description_error', null, 'service_description', '', '', [], false, 'service_description', 0, 'This is displayed in the booking view.') ?>
                            </div>
                        </section>
                        <section class="flex flex-col gap-[40px] w-[400px] sm:w-[400px]">
                            <div class="flex flex-col gap-[16px]">
                                <div class="flex flex-row gap-[8px] sm:mt-[115px] ">
                                    ...
                                    <?php Helper::render('Describe what comes with the service. This will appear as a list in the booking.') ?>
                                </div>
                        ...
                        <section class="flex flex-col gap-[16px] w-[400px] sm:w-[400px]">
                            <div class="flex flex-col mb-[48px] gap-[16px]">
                                ...
                                <?php SecondaryInputField::render('dropdownfield', 'Party Size', '', ['All choices', 'Solo only', 'Duo only', 'Trio only'], '', null, 'party_size', '', '', [], false, 'party_size', 0, 'This locks the party-size in the chosen setting.') ?>
                            </div>
                        </section>
                        <section class="flex flex-col gap-[16px] items-end w-[400px] sm:w-[400px]">
        ...
        <script src="http://localhost/TraditionsWellnessSpa/Project/app/views/js/Services/Services/AddNewServiceValidation.js"></script>
        <script src="http://localhost/TraditionsWellnessSpa/Project/app/views/js/Services/Services/AddNewServiceSelectionDOM.js"></script>
        <script src="http://localhost/TraditionsWellnessSpa/Project/app/views/js/Services/Services/AddNewServiceCategoryListener.js"></script>
