...
class AppointmentsChart
{
    public static function render($completedCount, $awaitingReviewCount, $ongoingCount, $upcomingCount, $pendingCount, $cancelledCount, $total): void
    {
        ...
        <div class="relative w-[140px] h-[140px]">
            <div id="appointmentData" class="absolute inset-0 bg-background dark:bg-darkBackground" data-series='$dataSeries'></div>
            <div id="chart" class="absolute inset-0 flex items-center justify-center bg-background dark:bg-darkBackground text-background dark:text-darkBackground""></div>
